...
<?php
	echo "<center>";
	$query="select slno,title,pri_author,sec_author,stitle,vol,issue,abs,doi,pub from publication_table p,abstract_table a where p.abs_id=$aid and p.abs_id=a.abs_id";
