<?php
	...
	$slno=htmlentities($_POST['record']);
	echo $slno;
	
	
	$author=(isset($_POST['author']))?$_POST['author']:'NA';
	...
	//delete the previous data and update record accondingly .... in preupdate.php
	include("preupdate.php");
	//now insert the newly submitted data
	include("verified_insert.php");
	//give header to verifiacation with a message data updated
	
	header("location:home.php?message=Data Updated");
?>